...
import com.flair.grammar.GermanGrammaticalTreePatterns;
...
class StanfordDocumentParserGermanStrategy extends BasicStanfordDocumentParserStrategy {
    ...
    private static String wordPattern = "[a-z\\u00e4\\u00f6\\u00fc\\u00df]+";
    ...
    private void inspectSentence(Tree tree, List<CoreLabel> words) {
        ...
        int numNounsPronounsAnswerParticles = countMatches(GermanGrammaticalTreePatterns.patternNounOrPronounOrAnswerParticle, tree);
        if (numVPs < 1) {
            ...
            if (numClausesPerSentence > 1) {
                ...
                // relative clauses
                int numDPronounRelativeClauses = countMatches(GermanGrammaticalTreePatterns.patternDPronounRelativeClauses, tree);
                int numWPronounRelativeClauses = countMatches(GermanGrammaticalTreePatterns.patternWPronounRelativeClauses, tree);
                ...
                int numClausalSubordination = numRelativeClauses + countMatches(GermanGrammaticalTreePatterns.patternClausalSubordination, tree);
                ...
                int numCoordinationSubClauses = countMatches(GermanGrammaticalTreePatterns.patternCoordinatedSubordinateClauses, tree);
                int numCoordinationMainClauses = countMatches(GermanGrammaticalTreePatterns.patternCoordinatedMainClauses, tree);
            ...
            if (labelTag != null && labelWord != null
                ...
                if (labelTag.startsWith("v")) {
                    ...
                    if (labelTag.startsWith("vm")) {
                        addConstructionOccurrence(GrammaticalConstruction.VERBTYP_MODAL, label.beginPosition(), label.endPosition(), labelWord);
                    } else if (labelTag.startsWith("va")) {
                        addConstructionOccurrence(GrammaticalConstruction.VERBTYP_AUXILIARIES, label.beginPosition(), label.endPosition(), labelWord);
                    } else if (labelTag.startsWith("vv")) {
                        addConstructionOccurrence(GrammaticalConstruction.VERBTYP_MAIN, label.beginPosition(), label.endPosition(), labelWord);
                    }

                    // verb forms
                    if (labelTag.endsWith("izu")) {
                        addConstructionOccurrence(GrammaticalConstruction.VERBFORM_TO_INFINITIVE, label.beginPosition(), label.endPosition(), labelWord);
                    } else if (labelTag.endsWith("inf")) {
                        if (foundToParticle) {
                            addConstructionOccurrence(GrammaticalConstruction.VERBFORM_TO_INFINITIVE, toParticleBeginPosition, label.endPosition(), labelWord);
                            foundToParticle = false;
                        } else {
                            addConstructionOccurrence(GrammaticalConstruction.VERBFORM_INFINITIVE, label.beginPosition(), label.endPosition(), labelWord);
                        }
                    } else if (labelTag.endsWith("pp")) {
                        addConstructionOccurrence(GrammaticalConstruction.VERBFORM_PARTICIPLE, label.beginPosition(), label.endPosition(), labelWord);
                    } else if (labelTag.endsWith("imp")) {
                        addConstructionOccurrence(GrammaticalConstruction.IMPERATIVES, label.beginPosition(), label.endPosition(), labelWord);
                    }
                } else {
                    ...
                    if (foundAdjacentVerb) {
                        if (sizeVerbCluster > 1) {
                            addConstructionOccurrence(GrammaticalConstruction.VERB_CLUSTER, verbClusterBeginPosition, verbClusterEndPosition, verbClusterString.toString());
                        }
                    ...
                    if (labelTag.startsWith("adj")) {
                        ...
                        if (foundAdjectiveParticle) {
                            addConstructionOccurrence(GrammaticalConstruction.PARTICLE_PLUS_ADJ_ADV, adjectiveParticleBeginPosition, label.endPosition(), labelWord);
                        }
                        ...
                        addConstructionOccurrence(GrammaticalConstruction.CARDINALS, label.beginPosition(), label.endPosition(), labelWord);
                    } // prepositions
                    else if (labelTag.startsWith("appr") && labelWord.matches(wordPattern)) {
                        addConstructionOccurrence(GrammaticalConstruction.PREPOSITIONS, label.beginPosition(), label.endPosition(), labelWord);
                        addConstructionOccurrence(GrammaticalConstruction.PREPOSITIONS_SIMPLE, label.beginPosition(), label.endPosition(), labelWord);
                    } else if (labelTag.equalsIgnoreCase("appo")) {
                        addConstructionOccurrence(GrammaticalConstruction.PREPOSITIONS, label.beginPosition(), label.endPosition(), labelWord);
                        addConstructionOccurrence(GrammaticalConstruction.PREPOSITIONS_ADVANCED, label.beginPosition(), label.endPosition(), labelWord);
                        ...
                        if (labelTag.startsWith("ptk")) {
                        ...
                        } else { // if it's not a particle, it is a pronoun
                            ...
                            if (labelTag.equalsIgnoreCase("pper")) {
                                addConstructionOccurrence(GrammaticalConstruction.PRONOUNS_PERSONAL, label.beginPosition(), label.endPosition(), labelWord);
                                ...
                                addConstructionOccurrence(GrammaticalConstruction.PRONOUNS_DEMONSTRATIVE, label.beginPosition(), label.endPosition(), labelWord);
                            } else if (labelTag.startsWith("prel")) {
                                addConstructionOccurrence(GrammaticalConstruction.PRONOUNS_RELATIVE, label.beginPosition(), label.endPosition(), labelWord);
                            } else if (labelTag.startsWith("pi")) {
                                addConstructionOccurrence(GrammaticalConstruction.PRONOUNS_INDEFINITE, label.beginPosition(), label.endPosition(), labelWord);

                                if (EnglishGrammaticalConstants.SOME_DETERMINERS.contains(labelWord) || labelWord.startsWith("manch") || labelWord.startsWith("einige")) {
                                    addConstructionOccurrence(GrammaticalConstruction.DETERMINER_SOME, label.beginPosition(), label.endPosition(), labelWord);
                                } else if (labelWord.startsWith("irgend")) {
                                    addConstructionOccurrence(GrammaticalConstruction.DETERMINER_ANY, label.beginPosition(), label.endPosition(), labelWord);
                                } else if (labelWord.startsWith("viel")) {
                                    addConstructionOccurrence(GrammaticalConstruction.DETERMINER_MANY, label.beginPosition(), label.endPosition(), labelWord);
                                }
                            } else if (labelTag.startsWith("pw")) {
                                addConstructionOccurrence(GrammaticalConstruction.PRONOUNS_INTERROGATIVE, label.beginPosition(), label.endPosition(), labelWord);
                            }
                        }
                    ...
                    // determiners
                        ...
                        } else if (labelWord.equalsIgnoreCase("der") || labelWord.equalsIgnoreCase("den") || labelWord.equalsIgnoreCase("dem")
                                || labelWord.equalsIgnoreCase("des") || labelWord.equalsIgnoreCase("die")) {
                            addConstructionOccurrence(GrammaticalConstruction.ARTICLES, label.beginPosition(), label.endPosition(), labelWord);
                        ...
                        if (labelWord.endsWith("ungen") || labelWord.endsWith("ung")) {
                            addConstructionOccurrence(GrammaticalConstruction.NOUNS_UNG, label.beginPosition(), label.endPosition(), labelWord);
                        } else if (labelWord.endsWith("ismen") || labelWord.endsWith("ismus")) {
                            addConstructionOccurrence(GrammaticalConstruction.NOUNS_ISMUS, label.beginPosition(), label.endPosition(), labelWord);
                        } else if (labelWord.endsWith("turen") || labelWord.endsWith("tur")) {
                            addConstructionOccurrence(GrammaticalConstruction.NOUNS_TUR, label.beginPosition(), label.endPosition(), labelWord);
                        }
                        // @TODO add more suffixes
                        /**
                         * if (labelWord.endsWith("ant") ||
                         * labelWord.endsWith("anten") ||
                         * labelWord.endsWith("antin") ||
                         * labelWord.endsWith("antinnen") ||
                         * labelWord.endsWith("atur") ||
                         * labelWord.endsWith("aturen") ||
                         * labelWord.endsWith("ator") ||
                         * labelWord.endsWith("atoren") ||
                         * labelWord.endsWith("atorin") ||
                         * labelWord.endsWith("atorinnen") ||
                         * labelWord.endsWith("arium") ||
                         * labelWord.endsWith("arien") ||
                         * labelWord.endsWith("at") || labelWord.endsWith("ate")
                         * || labelWord.endsWith("eur") ||
                         * labelWord.endsWith("eure") ||
                         * labelWord.endsWith("eurin") ||
                         * labelWord.endsWith("eurinnen") ||
                         * labelWord.endsWith("ent") ||
                         * labelWord.endsWith("ents") ||
                         * labelWord.endsWith("enz") ||
                         * labelWord.endsWith("enzen") ||
                         * labelWord.endsWith("ast") ||
                         * labelWord.endsWith("asten") ||
                         * labelWord.endsWith("astin") ||
                         * labelWord.endsWith("astinnen") ||
                         * labelWord.endsWith("ist") ||
                         * labelWord.endsWith("isten") ||
                         * labelWord.endsWith("istin") ||
                         * labelWord.endsWith("istinnen") ||
                         * labelWord.endsWith("ität") ||
                         * labelWord.endsWith("itäten") ||
                         * labelWord.endsWith("ismus") ||
                         * labelWord.endsWith("ismen") ||
                         * labelWord.endsWith("ion") ||
                         * labelWord.endsWith("ionen") ||
                         * labelWord.endsWith("ur") ||
                         * labelWord.endsWith("uren") ||
                         * labelWord.endsWith("oid") ||
                         * labelWord.endsWith("oiden") ||
                         * labelWord.endsWith("istik") ||
                         * labelWord.endsWith("istiken") ||
                         * labelWord.endsWith("itis") ||
                         * labelWord.endsWith("sis")) {
                         *
                         * }*
                         */
                    }
                ...
                // negation
                if (EnglishGrammaticalConstants.NEGATION.contains(labelWord) || labelTag.equalsIgnoreCase("ptkneg")) {
                    addConstructionOccurrence(GrammaticalConstruction.NEGATION_ALL, label.beginPosition(), label.endPosition(), labelWord);
                    addConstructionOccurrence(GrammaticalConstruction.NEGATION_NO_NOT_NEVER, label.beginPosition(), label.endPosition(), labelWord);
                } else if (EnglishGrammaticalConstants.PARTIAL_NEGATION.contains(labelWord)) {
                    addConstructionOccurrence(GrammaticalConstruction.NEGATION_ALL, label.beginPosition(), label.endPosition(), labelWord);
                    addConstructionOccurrence(GrammaticalConstruction.NEGATION_PARTIAL, label.beginPosition(), label.endPosition(), labelWord);
                }
            }
        }
            ...
            for (CoreMap itr : sentences) {
                if (itr.size() > 0) {
                    ...
                    for (CoreLabel cl : words) {
                        ...
                        if (cl.value().toLowerCase().matches(wordPattern)) {
                            wordCount++;
