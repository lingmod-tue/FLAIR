...
public class PassiveFiBConstructionComponents extends ConstructionComponents {

	public PassiveFiBConstructionComponents(TaskItem taskItem) {
		super(taskItem);
		...
		firstLevelConstructions.add(new Pair<MaterialCheckBox, String>(this.taskItem.chkScopeActive, "active"));			
