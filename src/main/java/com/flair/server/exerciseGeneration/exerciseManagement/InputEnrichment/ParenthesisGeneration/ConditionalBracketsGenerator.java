...
public class ConditionalBracketsGenerator extends BracketsGenerator {
	...
	protected void generateBracketsContents(NlpManager nlpManager, ConstructionTextPart construction, 
        ...
        if (bracketsProperties.contains(BracketsProperties.CONDITIONAL_TYPE)) {
        	construction.getBrackets().add(construction.getConstructionType().equals(DetailedConstruction.CONDREAL) || 
            		construction.getConstructionType().equals(DetailedConstruction.CONDREAL_MAIN) || 
            		construction.getConstructionType().equals(DetailedConstruction.CONDREAL_IF) ? "real" : "unreal");
        }
