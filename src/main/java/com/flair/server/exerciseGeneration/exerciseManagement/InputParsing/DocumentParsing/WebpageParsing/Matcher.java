...
public class Matcher {
     ...
     */
    public void prepareDomForSplitting(WebpageData data){
    	indexedSentences = data.getFragments();
        textIndices = data.getTextIndices();
        
        replacePlainText(data.getDocument());
        data.setTextBoundaries(new Pair<>(startNode, endNode));
        data.setPlainTextElements(plainTextElements);
        data.setSentenceBoundaryElements(sentenceBoundaryElements);
    }
    ...
    private Element createPlainTextReplacementElement(String text, int startIndex,
        ...
        plainTextElements.put(plainTextCounter, sb.toString());
