...
public class SentenceManager {
     ...
     */
    public static void extractSentencesFromDom(WebpageData data) {
        ArrayList<ArrayList<Element>> sentences = new ArrayList<>();

        for(Boundaries sentenceBoundaries : data.getSentenceBoundaryElements()) {
        ...
        replaceSentencesInDom(sentences, data);
    }
     ...
     * @return 			The HTML strings of the replaced sentences
     */
    private static void replaceSentencesInDom(ArrayList<ArrayList<Element>> sentences, WebpageData data) {
        ...
        for(ArrayList<Element> sentence : sentences) {
            ...
            data.getSentenceHtml().add(htmlText.toString());
        }
    }
     ...
     */
    private static ArrayList<ArrayList<Element>> mergeSentences(ArrayList<ArrayList<Element>> previousSentences, 
     ...
     */
    private static ArrayList<Element> getMinimalAdjoiningElements(ArrayList<Element> elementsToMerge) {
