...
public class ConstructionPreparer {
	 ...
	 */
    public static void prepareConstructions(ExerciseSettings exerciseSettings, NlpManager nlpManager) {
                ...
                if(clauses != null) {                	
                    ...
                    if(exerciseSettings.getContentType().equals(ExerciseType.DRAG_MULTI)) {
                    	if(newConstructions.size() < 2) {
                    		...
                    		storeOtherConstructionsInSentence(exerciseSettings, new ArrayList<Construction>(newConstructions));                       	
                        }
                    }
    ...
    private static void storeOtherConstructionsInSentence(ExerciseSettings exerciseSettings, ArrayList<Construction> newConstructions) {
