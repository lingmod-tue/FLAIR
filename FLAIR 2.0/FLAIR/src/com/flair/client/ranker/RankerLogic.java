...
{	
	...
	private static class RankerWeights
	{
		...
		public final Map<GrammaticalConstruction,
						WeightData> 	gram;
		
		public RankerWeights(RankerLogicInput.Rank input)
		{
	...
	private static class RankOperationOutput implements RankerLogicOutput.Rank
	{
	...
	private boolean isDocConstructionFiltered(RankerLogicInput.Rank input, RankableDocument doc)
	{
		for (GrammaticalConstruction itr : doc.getConstructions())	
		{
	...
	public RankerLogicOutput.Rank rerank(RankerLogicInput.Rank input)
	{
		...
		{
			Collections.sort(out.docs, (a, b) -> {
				return (int)(a.getOrgRank() - b.getOrgRank());  
			});
		}
