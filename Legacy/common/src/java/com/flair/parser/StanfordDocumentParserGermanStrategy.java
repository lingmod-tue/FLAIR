...
import com.flair.grammar.GermanGrammaticalConstants;
...
class StanfordDocumentParserGermanStrategy extends BasicStanfordDocumentParserStrategy {
    ...
    private void initializeState(AbstractDocument doc) {
        if (pipeline == null) {
            ...
            throw new IllegalArgumentException("Document language " + doc.getLanguage() + " not supported (Strategy language: " + Language.GERMAN + ")");
        }
                    ...
                    if (labelTag.startsWith("adj")) {
                        ...
                        if (labelTag.startsWith("ptk")) {
                            ...
                            if (labelTag.equalsIgnoreCase("pper")) {
                                ...
                                if (GermanGrammaticalConstants.SOME_DETERMINERS.contains(labelWord) || labelWord.startsWith("manch") || labelWord.startsWith("einige")) {
